...
@Component({
  ...
  styles: [`
    ...
    .company-cover { position: relative; height: 142px; overflow: hidden; border-radius: 16px 16px 0 0; background: linear-gradient(120deg, #18181b, #3f3f46); }
    ...
    .cover-orb { position: absolute; border-radius: 50%; background: rgb(255 255 255 / .1); filter: blur(1px); }
    ...
    .company-hero { position: relative; z-index: 1; display: grid; grid-template-columns: 80px minmax(0, 1fr); align-items: center; gap: 20px; min-height: 132px; margin: -42px 24px 0; padding: 22px 26px; border: 1px solid var(--color-border-light); border-radius: 16px; background: var(--color-bg-secondary); box-shadow: 0 4px 14px rgb(24 24 27 / .06); }
    .company-avatar { display: grid; width: 80px; height: 80px; place-items: center; border: 5px solid var(--color-bg-secondary); border-radius: 18px; color: #fff; background: #18181b; box-shadow: 0 8px 18px rgb(24 24 27 / .14); font-family: var(--font-mono); font-size: 30px; font-weight: 700; }
    ...
    .metric-card { position: relative; display: flex; min-height: 144px; padding: 24px; flex-direction: column; align-items: flex-start; justify-content: space-between; border: 1px solid var(--color-border-light); border-radius: 16px; background: var(--color-bg-secondary); box-shadow: var(--shadow-card); overflow: hidden; }
    .metric-card::after { position: absolute; right: -22px; bottom: -33px; width: 95px; height: 95px; border: 1px solid rgb(161 161 170 / .22); border-radius: 50%; content: ''; }
    .metric-card--accent { border-color: var(--color-border-light); background: #fff; }
    .metric-icon { display: none; }
    .metric-card--accent .metric-icon { display: none; }
    .metric-label { color: var(--color-text-secondary); font-size: 10px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; }
    .metric-card strong { color: var(--color-text-primary); font-family: var(--font-mono); font-size: 36px; font-variant-numeric: tabular-nums; letter-spacing: -.04em; line-height: 1; }
    ...
    .workflow-card { margin-top: 15px; background: #fff; }
    :host ::ng-deep .workflow-card .ant-card-body { display: flex; align-items: flex-start; gap: 12px; padding: 17px; }
    .workflow-card > span { display: grid; flex: 0 0 auto; width: 34px; height: 34px; place-items: center; border-radius: 10px; color: #18181b; background: #f4f4f5; font-size: 16px; }
